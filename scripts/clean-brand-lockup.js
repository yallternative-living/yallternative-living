...
htmlFiles.forEach(file => {
  ...
  // Replace the HTML
  const regex = /<span class="brand-word">Y'allternative<small>Living<\/small><\/span>/g;
  const newHTML = `<span class="brand-word">Y'allternative <span class="brand-sub">Living</span></span>`;
