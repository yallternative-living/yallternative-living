/**
 * @fileoverview Build reproducibility and determinism verification script.
 *
 * Executes consecutive site builds with artificial delays to ensure that all
 * generated files, metadata, Service Worker caches, and RSS feeds produce
 * 100% byte-identical, deterministic output without time-dependent drift.
 */
...
/**
 * Computes a SHA-256 hex digest for a file on disk.
 * @param {string} filePath Absolute path to the file to hash.
 * @return {string} Hexadecimal SHA-256 digest of the file contents.
 */
...
/**
 * Recursively collects all file paths within a directory, ignoring hidden files and node_modules.
 * @param {string} dir Absolute directory path to traverse.
 * @param {!Array<string>=} fileList Accumulated list of file paths.
 * @return {!Array<string>} Array of absolute file paths found within the directory.
 */
