...
- **What you can manage here:**
  - **Products:** Add new items, update prices, change descriptions, edit ingredients, set stock levels and photos with instant 1-click filter chips, category groups, and live preview links. Technical item IDs are autogenerated for you.
  - **Journal:** Publish blog posts, announcements, and story updates (one entry per post) with live preview links.
  - **Shop & Catalog Settings:** Shipping thresholds, cart reward tiers, multi-buy deals, category sales, gift bundles, and FAQ.
