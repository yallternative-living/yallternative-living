  ...
  "bundles": [
    {
      ...
      "discountPercent": 10,
      "blurb": "The whole shop in miniature: the do-everything salve folks keep re-ordering, the bourbon-vanilla scrub that gets your hands actually clean, and the bug spray nobody admits they need until August. Three of our most-reviewed goods, one easy yes."
    },
    {
    ...
    {
      "id": "night-ritual-set",
      "name": "Night Ritual Set",
      "productIds": [
        "sleep-salve",
        "shea-butter"
      ],
      "discountPercent": 10,
      "blurb": "A wind-down in two steps: massage the lavender shea butter into damp skin after a shower, then work the magnesium sleep salve into feet and shoulders and let lavender, chamomile and cedarwood take it from there. Built for night owls and overthinkers."
    },
    {
      "id": "pride-set",
